...
export default class Calculator extends Component{
    ...
    setOperation(operation){
        if(this.state.current === 0){
            this.setState({operation, current: 1, clearDisplay: true}) //Muda o índice do array e começa a digitar no índice 1 depois que o usuário clica na operação
        }
        else{
            ...
            try{
                ...
                values[0] = eval(`${values[0]} ${currentOperation} ${values[1]}`) //Pega o primeiro valor no índicie 0, reconhece a operação pelo "currentOperation", pega o segundo valor no índicie 1 e com a operação reconhecida e armazenada, processa e mostra o resultado
